...
cg_filt=subset_samples(cg, keep_2026 =='yes')
physeq_filtered <- prune_taxa(taxa_sums(cg_filt) > 2, cg_filt)
...
palette_genus=c('Aestuariibacter' ="#e59d97",
'Aquibacter' ="#ffcaa5",
'Candidatus Pelagibacter' ="#e9daa2",
'Cellulophaga' ="#afb780",
'Marinobacterium' ="#f8fff1",
...
subset_family = subset_taxa(try1, family %in% c("Flavobacteriales", "Oceanospirillales", "Alteromonadales", "Vibrionales", "SAR 11") )
subset_family = subset_taxa(try1, species %in% c("Aestuariibacter","Aquibacter","Candidatus Pelagibacter","Cellulophaga","Marinobacterium","Marinomonas","Neptuniibacter","Owenweeksia","Tenacibaculum","Vibrio","Wandonia") )

circle_pq(subset_family, fact="treatment_26", taxa = "species",
          min_prop_mod=0.001, min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette1, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)

circle_pq(subset_family, fact="treatment_26", taxa = "species",
          min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette1, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)
...
subset_family = subset_taxa(try1, species %in% c("Aestuariibacter","Aquibacter","Candidatus Pelagibacter","Cellulophaga","Marinobacterium","Marinomonas","Neptuniibacter","Owenweeksia","Tenacibaculum","Vibrio","Wandonia") )
row_colors=c( "#4D9DE0","#E15554",  "#3BB273", "#7768AE")
subset_family_co=subset_samples(subset_family, definition=="assemblage")
circle_pq(subset_family_co, fact="diatom_strain", taxa = "species",
          min_prop_mod=0.001, min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette1, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)

circle_pq(subset_family_co, fact="diatom_strain", taxa = "species",
          min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette1, row_col = palette_genus, log10trans = FALSE, rarefy=TRUE)


subset_family_micro=subset_samples(subset_family, definition=="microbiome")
circle_pq(subset_family_micro, fact="diatom_strain", taxa = "species",
          min_prop_mod=0.001, min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette1, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)
...
row_colors=c( "#4D9DE0","#E15554",  "#3BB273", "#7768AE")
subset_family_co=subset_samples(subset_family, definition=="assemblage")
abund=transform_sample_counts(subset_family_co, function(x) (x/sum(x)))
abund_1 = subset_taxa(abund, species %in% c("Aestuariibacter","Aquibacter","Candidatus Pelagibacter","Cellulophaga","Marinobacterium","Marinomonas","Neptuniibacter","Owenweeksia","Tenacibaculum","Vibrio","Wandonia") )
circle_pq(abund1, fact="diatom_strain", taxa = "species",
          min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=FALSE)


circle_pq(subset_family_co, fact="diatom_strain", taxa = "species",
        min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)



circle_pq(abund, fact="diatom_strain", taxa = "species",
          min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette1, row_col = row_colors, log10trans = FALSE, rarefy=FALSE)


subset_family_micro=subset_samples(subset_family, definition=="microbiome")
circle_pq(subset_family_micro, fact="diatom_strain", taxa = "species",
          min_prop_mod=0.001, min_prop_tax=0.10,  add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)
subset_family_micro=subset_samples(subset_family, definition=="microbiome")
abund=transform_sample_counts(subset_family_micro, function(x) (x/sum(x)))

circle_pq(abund, fact="diatom_strain", taxa = "species",
          min_prop_tax=0.015,  add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=FALSE)
abund_1 = subset_taxa(abund, species %in% c("Aestuariibacter","Aquibacter","Candidatus Pelagibacter","Cellulophaga","Marinobacterium","Marinomonas","Neptuniibacter","Owenweeksia","Tenacibaculum","Vibrio","Wandonia") )
circle_pq(abund_1, fact="diatom_strain", taxa = "species",
          min_prop_tax=0.05,  add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=FALSE)
...
subset_family_co=subset_samples(try1, definition=="assemblage")
abund=transform_sample_counts(subset_family_co, function(x) (x/sum(x)))
abund_1 = subset_taxa(subset_family_co, species %in% c("Aestuariibacter","Aquibacter","Candidatus Pelagibacter","Cellulophaga","Marinobacterium","Marinomonas","Neptuniibacter","Owenweeksia","Tenacibaculum","Vibrio","Wandonia") )
circle_pq(abund_1, fact="diatom_strain", taxa = "species",
            add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)

## attached bacteria
subset_family_micro=subset_samples(try1, definition=="microbiome")
#abund=transform_sample_counts(subset_family_micro, function(x) (x/sum(x)))
abund_1 = subset_taxa(subset_family_micro, species %in% c("Aestuariibacter","Aquibacter","Candidatus Pelagibacter","Cellulophaga","Marinobacterium","Marinomonas","Neptuniibacter","Owenweeksia","Tenacibaculum","Vibrio","Wandonia") )
circle_pq(abund_1, fact="diatom_strain", taxa = "species",
           add_nb_seq=TRUE, grid_col=palette_genus, row_col = row_colors, log10trans = FALSE, rarefy=TRUE)
```
# nst
...
palette=c("#631879", "#3B4992", "#EE0000", "#008B45")

{
  
  par(mar=c(10,
            5,1,1),xpd=FALSE)
  plot(p$x[,1],p$x[,2],pch=21,cex=2,
     bg=c("#008B45", "#008B45", "#008B45", '#631879',"#631879","#631879", '#3B4992', "#3B4992", "#3B4992", '#EE0000', "#EE0000", "#EE0000"),
     xlab = "PCoA1 26.94 %",
     ylab= "PCoA2 16.00 %",
     yaxt='n')
  axis(2, at=c(-2,0,2))
ordiellipse(p$x,
          group=as.factor(sample_data(comp_clr)$strain_26),
           col=c('#631879', '#3B4992', '#EE0000','#008B45'),
...
# variance stabilizing transformation 
# from 16S stats 
ddst=phyloseq_to_deseq2(cg_filt2,~strain_26)
# 
gm_mean = function(x, na.rm=TRUE){
  exp(sum(log(x[x > 0]), na.rm=na.rm) / length(x))
}
...

{
  ...
  par(mar=c(15,
            5,1,1),xpd=FALSE)
  plot(p$x[,1],p$x[,2],pch=23, cex=2,
     bg=sample_data(comp_clr)$col_26,
     xlab = "PCoA1 36 %",
     ylab= "PCoA2 11 %", 
     yaxt='n', xaxt='n')
ordiellipse(p$x,
